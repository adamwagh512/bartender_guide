...
const mainpage = () => {
  return (
    ...
    <div className='w-full h-screen bg-[#070e26] text-[#F2B950]'>
        <Image
        className='w-screen sm:h-[50%] md:h-[60%]'
        src={hero}
        >
